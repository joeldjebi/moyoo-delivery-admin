        ...
        <div class="col-lg-12 mb-4 order-0">
            <div class="card">
                <div class="d-flex align-items-end row">
                    <div class="col-sm-7">
                        <div class="card-body">
                            <h5 class="card-title text-primary">Modifier la Catégorie</h5>
                            <p class="mb-4">Modifiez les informations de la catégorie.</p>
                        </div>
                    </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    <input type="text"
                                           ...
                                           id="icon"
                                           name="icon"
                                           value="{{ old('icon', $category->icon ?? 'ti ti-box') }}"
                                ...
                                <div class="mt-2">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <i id="iconPreview" class="{{ old('icon', $category->icon ?? 'ti ti-box') }} me-2" style="font-size: 1.5rem;"></i>
                                        <span id="iconPreviewText" class="text-muted small">{{ old('icon', $category->icon ?? 'ti ti-box') }}</span>
                                    </div>
                                </div>
                            </div>
