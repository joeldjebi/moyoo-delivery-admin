        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body text-center py-5">
                    ...
                    <!-- Titre principal -->
                    <h2 class="text-danger mb-3">Abonnement Requis</h2>
                    <p class="text-muted mb-4">Un abonnement actif est requis pour accéder à cette fonctionnalité.</p>
                    ...
                    <div class="alert alert-danger border-0 shadow-sm mb-4">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="flex-grow-1">
                                <h5 class="alert-heading mb-1">Accès Restreint</h5>
                                <p class="mb-0">Cette fonctionnalité nécessite un abonnement actif pour être utilisée.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="text-center mb-5">
                        ...
                        <p class="text-muted mt-2 mb-0">
                            <small>✓ Plans flexibles • ✓ Activation immédiate • ✓ Support 24/7</small>
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-8">
                            <p class="lead mt-4">Imaginez avoir une tour de contrôle comme dans un aéroport, mais pour vos livraisons. Le Moniteur Admin est exactement cela : votre centre de commandement digital qui vous donne une vue d'ensemble complète de toutes vos opérations en temps réel.</p>
    ...
    <div class="row mb-5">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <p class="lead text-center mb-4 mt-4">Le Moniteur Admin n'est pas juste un outil de surveillance, c'est un <strong>multiplicateur de performance</strong> qui transforme chaque aspect de votre activité de livraison.</p>
                        ...
                        <div class="col-12">
                            <div class="card border-success">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <h6 class="text-danger mt-4">❌ AVANT le Moniteur Admin :</h6>
                                        ...
                                        <div class="col-md-6">
                                            <h6 class="text-success mt-4">✅ APRÈS le Moniteur Admin :</h6>
                                            <ul class="list-unstyled">
    ...
    <div class="row mb-5">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <p class="lead text-center mb-4 mt-4">Chaque fonctionnalité du Moniteur Admin est conçue pour résoudre un problème spécifique que vous rencontrez quotidiennement.</p>
