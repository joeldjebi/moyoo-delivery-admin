        ...
        <div class="col-lg-12 mb-4 order-0">
            <div class="card">
                <div class="row">
                    <div class="col-sm-7">
                        <div class="card-body">
                            <h5 class="card-title text-primary">Modifier la Boutique</h5>
                            <p class="mb-4">Modifiez les informations de la boutique : {{ $boutique->libelle }}</p>
                        </div>
                    </div>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('boutiques.update', $boutique) }}" method="POST" id="boutiqueForm" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text"
                                       ...
                                       id="libelle"
                                       name="libelle"
                                       value="{{ old('libelle', $boutique->libelle) }}"
                                ...
                                <select class="form-select @error('marchand_id') is-invalid @enderror"
                                    ...
                                    @foreach($marchands as $marchand)
                                        <option value="{{ $marchand->id }}"
                                                {{ old('marchand_id', $boutique->marchand_id) == $marchand->id ? 'selected' : '' }}>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="tel"
                                       ...
                                       id="mobile"
                                       name="mobile"
                                       value="{{ old('mobile', $boutique->mobile) }}"
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <textarea class="form-control @error('adresse') is-invalid @enderror"
                                          ...
                                          name="adresse"
                                          rows="3"
                                          placeholder="Entrez l'adresse complète de la boutique">{{ old('adresse', $boutique->adresse) }}</textarea>
                                @error('adresse')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="url"
                                       ...
                                       id="adresse_gps"
                                       name="adresse_gps"
                                       value="{{ old('adresse_gps', $boutique->adresse_gps) }}"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                @if($boutique->cover_image)
                                    <div class="mb-2">
                                        <img src="{{ asset('storage/' . $boutique->cover_image) }}" alt="Image actuelle" class="img-thumbnail" style="max-width: 100px; max-height: 100px;">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('status') is-invalid @enderror"
                                    ...
                                    <option value="active" {{ old('status', $boutique->status) == 'active' ? 'selected' : '' }}>Actif</option>
                                    <option value="inactive" {{ old('status', $boutique->status) == 'inactive' ? 'selected' : '' }}>Inactif</option>
                                </select>
                                @error('status')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
