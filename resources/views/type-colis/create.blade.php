        ...
        <div class="col-lg-12 mb-4 order-0">
            <div class="card">
                <div class="row">
                    <div class="col-sm-7">
                        <div class="card-body">
                            <h5 class="card-title text-primary">Ajouter un Type de Colis</h5>
                            <p class="mb-4">Créez un nouveau type de colis pour votre système de livraison</p>
                        </div>
                    </div>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('type-colis.store') }}" method="POST" id="createTypeColisForm">
                        @csrf
...
document.getElementById('createTypeColisForm').addEventListener('submit', function(e) {
