...
<div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
  ...
  <ul class="navbar-nav flex-row align-items-center ms-auto">
        ...
        <div class="dropdown-shortcuts-list scrollable-container">
          ...
          <div class="row row-bordered overflow-visible g-0">
            <div class="dropdown-shortcuts-item col">
              ...
              <a href="{{ route('users.index') }}" class="stretched-link">Gestion Utilisateurs</a>
              <small>Créer et gérer les utilisateurs</small>
            </div>
            <div class="dropdown-shortcuts-item col">
              <span class="dropdown-shortcuts-icon rounded-circle mb-3">
    ...
    <li class="nav-item navbar-dropdown dropdown-user dropdown">
      ...
      <ul class="dropdown-menu dropdown-menu-end">
        <li>
          <a class="dropdown-item mt-0" href="{{ route('auth.profile') }}">
        ...
        <li>
          <a class="dropdown-item" href="{{ route('auth.subscription-history') }}">
        ...
        <li>
          <a class="dropdown-item" href="{{ route('auth.pricing') }}">
            <i class="ti ti-currency-dollar me-3 ti-md"></i><span class="align-middle">Forfaits</span>
          </a>
        </li>
        <li>
          <a class="dropdown-item" href="{{ route('auth.faq') }}">
