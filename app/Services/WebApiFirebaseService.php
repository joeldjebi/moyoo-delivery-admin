...
class WebApiFirebaseService
{
    private $projectId = 'moyoo-fleet';
    private $webApiKey = 'AIzaSyAWezTKUpu9trZW1gb2PnKVqKX4r4aUTWI';

    public function __construct()
    {
        // Vérifier la configuration
        if (!$this->projectId || !$this->webApiKey) {
    ...
    {
        try {
            // Utiliser l'API Legacy de Firebase
            ...
            curl_setopt($ch, CURLOPT_HTTPHEADER, [
                ...
                'Authorization: key=' . $this->webApiKey
            ]);
            ...
            // Log de la réponse
            Log::info('MOYOO Firebase Notification Sent (Web API)', [
                'project_id' => $this->projectId,
                'web_api_key' => substr($this->webApiKey, 0, 10) . '...',
                'payload' => $payload,
                'response' => $result,
            ...
            Log::error('MOYOO Firebase Notification Error (Web API)', [
                'project_id' => $this->projectId,
                'error' => $e->getMessage(),
