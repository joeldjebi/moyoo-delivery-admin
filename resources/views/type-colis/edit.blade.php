        ...
        <div class="col-lg-12 mb-4 order-0">
            <div class="card">
                <div class="row">
                    <div class="col-sm-7">
                        <div class="card-body">
                            <h5 class="card-title text-primary">Modifier le Type de Colis</h5>
                            <p class="mb-4">Modifiez les informations du type de colis : {{ $type_colis->libelle }}</p>
                        </div>
                    </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title mb-0">Informations du Type de Colis</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('type-colis.update', $type_colis) }}" method="POST" id="editTypeColisForm">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                ...
                                <input type="text"
                                       ...
                                       id="libelle"
                                       name="libelle"
                                       value="{{ old('libelle', $type_colis->libelle) }}"
                                       placeholder="Ex: Document, Vêtement, Électronique, Alimentaire..."
                                       required>
                                @error('libelle')
...
document.getElementById('editTypeColisForm').addEventListener('submit', function(e) {
