        ...
        <div class="col-lg-12 mb-4 order-0">
            <div class="card">
                <div class="row">
                    <div class="col-sm-7">
                        <div class="card-body">
                            <h5 class="card-title text-primary">Modifier le Marchand</h5>
                            <p class="mb-4">Modifiez les informations du marchand : {{ $marchand->full_name }}</p>
                        </div>
                    </div>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('marchands.update', $marchand) }}" method="POST" id="marchandForm">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text"
                                       ...
                                       id="first_name"
                                       name="first_name"
                                       value="{{ old('first_name', $marchand->first_name) }}"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text"
                                       ...
                                       id="last_name"
                                       name="last_name"
                                       value="{{ old('last_name', $marchand->last_name) }}"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="tel"
                                       ...
                                       id="mobile"
                                       name="mobile"
                                       value="{{ old('mobile', $marchand->mobile) }}"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="email"
                                       ...
                                       id="email"
                                       name="email"
                                       value="{{ old('email', $marchand->email) }}"
                                ...
                                <select class="form-select @error('commune_id') is-invalid @enderror"
                                    ...
                                    @foreach($communes as $commune)
                                        <option value="{{ $commune->id }}"
                                                {{ old('commune_id', $marchand->commune_id) == $commune->id ? 'selected' : '' }}>
                                            {{ $commune->libelle }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('status') is-invalid @enderror"
                                    ...
                                    <option value="active" {{ old('status', $marchand->status) == 'active' ? 'selected' : '' }}>Actif</option>
                                    <option value="inactive" {{ old('status', $marchand->status) == 'inactive' ? 'selected' : '' }}>Inactif</option>
                                </select>
                                @error('status')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <textarea class="form-control @error('adresse') is-invalid @enderror"
                                          ...
                                          name="adresse"
                                          rows="3"
                                          placeholder="Entrez l'adresse complète">{{ old('adresse', $marchand->adresse) }}</textarea>
                                @error('adresse')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
