    ...
    <div class="col-lg-12 mb-4 order-0">
        <div class="card">
            <div class="row">
                <div class="col-sm-7">
                    <div class="card-body">
                        <h5 class="card-title text-primary">Modifier l'Utilisateur</h5>
                        <p class="mb-4">Modifiez les informations de l'utilisateur</p>
                    </div>
                </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <small class="text-muted">Modifiez les permissions supplémentaires à celles du rôle</small>
                                </div>
                                <div class="card-body">
                                    @php
                                        $allPermissions = \App\Models\User::getAllAvailablePermissions();
                                        $currentCustomPermissions = $user->permissions ?? [];
                                                    ...
                                                    @foreach($permissions as $permission)
                                                        <div class="form-check mb-2">
                                                            <input class="form-check-input" type="checkbox"
                                                                   ...
                                                                   {{ in_array($permission, old('custom_permissions', $currentCustomPermissions)) ? 'checked' : '' }}>
                                    ...
                                    <div class="alert alert-info">
                                        ...
                                        <small>Les permissions personnalisées s'ajoutent aux permissions du rôle sélectionné. Décochez pour supprimer une permission personnalisée.</small>
                                    </div>
                                </div>
                            </div>
                        </div>
