        ...
        <div class="col-lg-12 mb-4 order-0">
            <div class="card">
                <div class="row">
                    <div class="col-sm-7">
                        <div class="card-body">
                            <h5 class="card-title text-primary">Modifier le Type d'Engin</h5>
                            <p class="mb-4">Modifiez les informations du type d'engin : {{ $type_engin->libelle }}</p>
                        </div>
                    </div>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('type-engins.update', $type_engin) }}" method="POST" id="editTypeEnginForm">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                ...
                                <input type="text"
                                       ...
                                       id="libelle"
                                       name="libelle"
                                       value="{{ old('libelle', $type_engin->libelle) }}"
...
document.getElementById('editTypeEnginForm').addEventListener('submit', function(e) {
